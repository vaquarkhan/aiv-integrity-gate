...
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/vaquarkhan/aiv-integrity-gate/main/scripts/install-aiv.sh | bash -s -- 1.0.4
#   AIV_VERSION=1.0.4 ./scripts/install-aiv.sh
set -euo pipefail
VERSION="${1:-${AIV_VERSION:-1.0.4}}"
