...
| **Design** | YAML rules for forbidden and required patterns. Case-insensitive keyword matching. Supports multiple languages via configurable file extensions. Includes rules for **AI slop detection**: emoji in code and AI attribution markers (e.g. "Generated by ChatGPT") — common tells of low-quality AI-generated content. |
...
| **AI slop: emoji** | Design rule `no-emoji-in-code` flags emoji in code/comments — a common tell of AI-generated slop. |
| **AI slop: attribution markers** | Design rule `no-ai-generated-markers` flags phrases like "Generated by AI", "Generated by ChatGPT/Copilot" — left behind when AI-generated code is committed without review. |
...
| **SHA-pinned actions** | All workflow actions pinned to full commit SHA to harden against supply chain attacks. |
| **Dependabot config** | `.github/dependabot.yml` limits GitHub Actions auto-updates to avoid unreviewed version bumps. |
...
| Feature | Description |
|---------|-------------|
| **JaCoCo enforcement** | Line coverage enforced at 70% minimum on `mvn verify`. |
| **Coverage reports** | Reports generated in `target/site/jacoco/index.html` per module. |
