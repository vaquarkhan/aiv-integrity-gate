...
class GitDiffProviderTest {
    ...
    @Test
    void getDiffWithInvalidRefReturnsEmpty() {
        var provider = new GitDiffProvider();
        Path workspace = Paths.get(".").toAbsolutePath();
        Diff diff = provider.getDiff(workspace, "nonexistent-ref-xyz", "HEAD");
        assertNotNull(diff);
